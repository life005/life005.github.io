...
function CustomTabs({ activeTab, setactiveTab }) {
  return (
    <div className='grid grid-cols-3 border-b border-blue-500'>
      ...
      <button
        className={`py-2 col-span-1 border-blue-900 text-center ${activeTab === 'mindfulness' ? 'border-t-4' : ''}`}
        onClick={() => setactiveTab('mindfulness')}
      >
        Mindfulness
      </button>
      <button
        className={`py-2 col-span-1 border-blue-900 text-center ${activeTab === 'calorie-tracker' ? 'border-t-4' : ''}`}
